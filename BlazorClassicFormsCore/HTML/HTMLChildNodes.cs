	...
	public class HTMLChildNodes
	{
		...
		public HTMLElement this[int index]
		{
			get
			{
				...
				{
					uid = dom.JSRuntime.Invoke<string>("element_childnode", new object[]
					{
						this.owner.uid,
						index
					})
		...
		public int length => dom.JSRuntime.Invoke<int>("element_childnode_count", new object[] { this.owner.uid });
