	...
	public class HTMLElement
	{
		...
		public Action<MouseEvent> onmousedown
		{
			set
			{
				...
				dom.JSRuntime.Invoke<object>("onmousedown", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<MouseEvent> ondblclick
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalMouseEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("ondblclick", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<Event> onchange
		{
			set
			{
				...
				dom.JSRuntime.Invoke<object>("onchange", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<Event> onpaste
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onpaste", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<Event> onkeydown
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onkeydown", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<Event> onkeyup
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onkeyup", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<Event> onclick
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onclick", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<Event> onblur
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onblur", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<MouseEvent> onmouseenter
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalMouseEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onmouseenter", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<MouseEvent> onmouseleave
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalMouseEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onmouseleave", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<MouseEvent> onmousemove
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalMouseEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onmousemove", new object[]
				{
					this.uid,
					text
				});
		...
		public Action<MouseEvent> onmouseup
		{
			set
			{
				string text = Guid.NewGuid().ToString();
				dom.normalMouseEvent.Add(text, value);
				dom.JSRuntime.Invoke<object>("onmouseup", new object[]
				{
					this.uid,
					text
				});
		...
		public HTMLElement parentElement
		{
			get
			{
				string value = dom.JSRuntime.Invoke<string>("element_parentElement_get", new object[]
				{
					this.uid
				});
			...
			set
			{
				dom.JSRuntime.Invoke<string>("element_parentElement_set", new object[]
				{
					this.uid,
					value
				});
		...
		{
			this.uid = dom.JSRuntime.Invoke<string>("createElement", new object[]
			{
				tag
			});
		}
		...
		public int tabIndex
		{
			get
			{
				return dom.JSRuntime.Invoke<int>("element_get", new object[]
				{
					this.uid,
					"tabIndex"
				});
			...
			set
			{
				dom.JSRuntime.Invoke<int>("element_set", new object[]
				{
					this.uid,
					"tabIndex",
					value
		...
		{
			dom.JSRuntime.Invoke<object>("appendChild", new object[]
			{
				this.uid,
				child.uid
			});
		...
		{
			dom.JSRuntime.Invoke<object>("removeChild", new object[]
			{
				this.uid,
				child.uid
			});
		...
		{
			dom.JSRuntime.Invoke<object>("insertBefore", new object[]
			{
				this.uid,
				child.uid,
				child2.uid
		...
		public string innerHTML
		{
			get
			{
				return dom.JSRuntime.Invoke<string>("innerHTML_get", new object[]
				{
					this.uid
				});
			}
			set
			{
				dom.JSRuntime.Invoke<string>("innerHTML_set", new object[]
				{
					this.uid,
					value
				});
		...
		{
			string[] array = dom.JSRuntime.Invoke<string>("getBoundingClientRect", new object[]
			{
				this.uid
			}).Split(new char[]
			{
		...
		public void focus()
		{
			dom.JSRuntime.Invoke<string>("element_call", new object[]
			{
				this.uid,
				"focus"
			});
		...
		{
			return dom.JSRuntime.Invoke<string>("getAttribute", new object[]
			{
				this.uid,
				name
			});
		...
		{
			return dom.JSRuntime.Invoke<string>("removeAttribute", new object[]
			{
				this.uid,
				name
			});
		...
		{
			dom.JSRuntime.Invoke<string>("setAttribute", new object[]
			{
				this.uid,
				name,
				value
