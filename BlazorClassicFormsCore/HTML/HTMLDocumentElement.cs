...
namespace BlazorClassicForms.HTML
{
	...
	public class HTMLDocumentElement : HTMLElement
	{
		...
		{
			this.uid = dom.JSRuntime.Invoke<string>("_document", Array.Empty<object>());
			this._body = new HTMLElement
			{
				uid = dom.JSRuntime.Invoke<string>("_body", Array.Empty<object>())
			};
		}
		...
		public HTMLDocumentFragement createDocumentFragment()
		{
			...
			{
				uid = dom.JSRuntime.Invoke<string>("createDocumentFragment", Array.Empty<object>())
			};
		}
		...
		public HTMLElement activeElement
		{
			get
			{
				...
				{
					uid = dom.JSRuntime.Invoke<string>("document_activeElement_get", Array.Empty<object>())
				};
			}
			set
			{
				dom.JSRuntime.Invoke<object>("document_activeElement_set", new object[]
				{
