namespace System.Windows.Forms.Layout
{
    ...
    internal class CommonProperties
    {
        ...
        internal static BitVector32 GetLayoutState(IArrangedElement element) =>
            new BitVector32(element.Properties.GetInteger(_layoutStateProperty));
        ...
        internal static bool GetNeedsDockAndAnchorLayout(IArrangedElement element) =>
            (GetLayoutState(element)[_dockAndAnchorNeedsLayoutSection] > 0);

        internal static bool GetNeedsDockLayout(IArrangedElement element) =>
            ((GetLayoutState(element)[_dockModeSection] == 1) && element.ParticipatesInLayout);
        ...
        internal static bool ShouldSelfSize(IArrangedElement element) =>
            (!GetAutoSize(element) || (((element.Container is Control) && (((Control)element.Container).LayoutEngine is DefaultLayout)) && GetSelfAutoSizeInDefaultLayout(element)));
